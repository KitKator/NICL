...
from IL.IL_train import IL_train
...
if __name__ == "__main__":
    ...
    model_root = 'E:\Experiments\ABCD\IL\B\Train_LR0.001_batch64_epoch50_adam_T=1\model_epoch_ir=0.001'
    model_name = 'epoch_19_stu_model.pth'
    ...
    for e in tqdm(range(0, N_EPOCHS+1)):
        if (e == 0):
            ...
            test(stu_model, criterion1, test_loader1, e, N_EPOCHS, device, RESULT_TEST1, loss_list_test1,
                 acc_list_test1)
            test(stu_model, criterion1, test_loader2, e, N_EPOCHS, device, RESULT_TEST2, loss_list_test2,
                 acc_list_test2)
            test(stu_model, criterion1, test_loader3, e, N_EPOCHS, device, RESULT_TEST3, loss_list_test3,
                 acc_list_test3)
        else:
            stu_model = IL_train(teacher_model, stu_model, criterion1, criterion2, alpha,
            ...
            test(stu_model, criterion1, test_loader2, e, N_EPOCHS, device, RESULT_TEST2, loss_list_test2, acc_list_test2)
